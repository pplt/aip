...
\setlist{itemsep=0.3em,leftmargin=2.8em}
\usepackage{booktabs}
\usepackage{xspace}
...
\newcommand{\smallcompatible}{small compatible}
\newcommand{\verysmallcompatible}{very small compatible}
\newcommand{\standard}{positive}
