...
\pedro[inline]{
   ...
   \pedro[inline]{Any objections to using ``Newton polyhedron of $A$'', rather than ``Newton polyhedron associated with/to $A$'', to save some words? 
   \emily[inline]{None here.}
   }
}
...
\pedro[inline]{
   \begin{example}
      ...
      \Cref{fig: collapse}(\textsc{a}) shows the Newton polyhedron associated to the collapse $\collapse{A}$ of $A$ along $\O$ (compare with \Cref{fig: newton polyhedron}).
