...
\daniel{Should we state the main result of this section?  \Cref{m-primary AIP: T}?} \emily{What about something instead like the second paragraph?}
...
\begin{theorem}[{\emph{Cf}.~\cite[Theorem~6.4]{hernandez+etal.frobenius_powers}}]
