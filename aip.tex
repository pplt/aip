...
%   We will prove that if $\rb(\O) \subseteq \rb(\L)$, then $\O =\L$.
   ...
   Since $\collapse{\L}$ is a face of $\collapse{\N}$ by \Cref{collapse of Newton polyhedron: P}, and $\lambda = \degree(\collapse{\matA},\vv{w})$ by \Cref{collapse of mf and mc: P}, the minimality of $\collapse{\O} = \mf(\collapse{\matA}, \vv{w})$ implies $\collapse{\O} \subseteq \collapse{\L}$, and invoking \Cref{collapse of Newton polyhedron: P} again we conclude that $\O \subseteq \L$.
