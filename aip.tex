...
\begin{proof}
   ...
   By \Cref{rem: finitely many F-thresholds of small pairs} the set consisting of the $F$-thresholds of all small $A$-pairs is finite, and consequently so is the set $S$ consisting of all special points with denominator $\denom$ of all small $A$-pairs.
