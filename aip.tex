...
\begin{proof}
   ...
   } \daniel{Nice catch.  It looks like we do need this.  I think probably can just state that critical exponents are discrete, and just cite our paper, in the proof.}
