...
Our first result will show that, even though the optimal set of an integer program $\ip$ may be infinite, 
\pedro{Is it ever not infinite?}
as shown in \Cref{ex: ft.3}, its image under $\collapse{A}$ is always finite.
...
We can now prove our finiteness result.
