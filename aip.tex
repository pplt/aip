...
\begin{proof}
   ...
   % }
   (Recall that by this we mean that the $i$-th coordinate of $A\vv{t}$ is less than $u_i$ whenever $\canvec_i\in \rs(\O)$.)
...
\begin{remark}[The $\idealm$-primary homogeneous case]
   ...
   \pedro[inline]{Maybe we could bring up this case more often throughout the paper; e.g., as an example when introducing minimal face, universal denominator, etc. }
\end{remark}
