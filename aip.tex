...
\emily{Is this an example or a remark?}
...
Observe that this set that depends on the class of $p$ modulo $\denom$\emily{Some {\tt ell} should be {\tt denom} below}, but not on $p$ itself.  Furthermore, \Cref{small pairs from shortfalls: E} tells us that every pair in $\S_{p^2}$ is small.
