...
\begin{theorem}
   ...
   Given a monomial ideal $\ideala$ of $\QQ[x_1, \ldots, x_\numvars]$, there exists a positive integer $\ell = \ell(\ideala)$, and for every positive $\vv{u} \in \NN^\numvars$ with $\ideala \subseteq \ideald = \ideal{ x_1^{u_1}, \ldots, x_m^{u_m} }$, and for every integer $1 \leq r < \ell$ relatively prime to $\ell$, there exist a positive integer $\beta = \beta(\ideala, \vv{u})$ and a sequence $\big(\epsilon(\ideala, \vv{u}, r, e)\big)_{e=1}^{\infty}$ of nonnegative rational numbers satisfying the following conditions.
   If $p > \beta$ and $p \equiv r \bmod \ell$, then
