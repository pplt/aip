...
\begin{proof}
   ...
   In view of \Cref{rmk: Frobenius powers of monomial ideals are monomial ideals}, this intersection is a monomial ideal, and thus contains a monomial $x^\vv{v}$ not in $\ideala^{[\lambda]}$.
