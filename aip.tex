...
\Cref{fig: sierpinski 3-gasket} illustrates the self-similarity of the Sierpi\'nski $3$-gasket in $\RR^2$.
...
\caption{$\opt \fip_5 = \opt \LP = \big\{\big(\frac2{25}, \frac3{50}\big)\big\}$}  
\end{subfigure}  
\begin{subfigure}{.49\textwidth}
\centering
