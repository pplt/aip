...
\[ \ideala = \langle x^{\vv{a}_1}, \ldots, x^{\vv{a}_n} \rangle \subseteq \kk[x_1, \cdots, x_d] \]
...
\daniel[inline]{I think this is definitely the place to start}
}
...
It is easy \daniel{This is true because we only look at monomial pairs.  Should we emphasize this?} to see that the feasible set of the integer program $\IP(A,\vv{u},q)$ is finite, and consequently this program has a well-defined value.
...
\begin{proposition}
   ...
   \begin{enumerate}
      ...
      \item\label{limit} The limit of $q^{-1}\val \IP(A,\vv{u},p^e)$, as $q$ tends to infinity. \daniel{I replaced this with a more general statement, since I am thinking we out to emphasize that this isn't necessarily a prime characteristic result}
