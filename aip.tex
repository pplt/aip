...
\emily[inline]{Definitely OK with me.  I am replacing instances of $d$ with the command {\tt \text{numvars}}, though I may have missed some. I changed it to $m$ in the meantime, in case we can find some missed ones.   Daniel, do you prefer $d$?  It does look like $m$ is used in several other ways, FYI.
}}
...
\begin{proof}
   ...
   Without loss of generality, suppose that $\rb(\O) = \{ \canvec_1, \ldots, \canvec_c \}$ for some $1 \leq c \leq \numvars-1$, and fix \emph{positive} integers $\numvars_1, \ldots, \numvars_c$ that sum to $\numvars-1$.
   ...
   \[ \frac{ d_1 \cdot \vv{s}_1 + \cdots + d_c \cdot  \vv{s}_c}{\numvars-1}  \]
...
\begin{claim} Given positive integers  $b_1, \cdots, b_{\ell}$ with $1 \leq \ell \leq \numvars$, there exists a finite subset $\mathcal{V}$ of $\NN^\numvars$, and for every $\vv{v} \in \mathcal{V}$ a finite subset $\mathcal{W}(\vv{v})$ of the set of standard basis vectors of $\ZZ^\numvars$,  satisfying the following conditions.
\begin{enumerate}
\setcounter{enumi}{2}
