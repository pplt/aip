...
\begin{example}
   ...
   Unlike the previous example, here $\sprout^*_p(A,\vv{u})$ is infinite---the last two levels repeat indefinitely.
\end{example}
...
\begin{example}
   ...
   For any $e\ge 5$ we have
     \[
      ...
      \end{cases}
   \]
   Moreover, if $(A,\vv{u})$ is associated to an ideal pair $(\ideala,\ideald)$, then
