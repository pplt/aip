...
Let $\idealb$ be an ideal of $\kk[x_1, \cdots, x_n]$ with either $\ideala \subseteq \sqrt \idealb$ or $\ideala \subseteq \idealb$.  In what remains of this article, we will be concerned with describing the numerical invariants $\nu(\ideala, \idealb, p^e)$ and $\ft{\ideala}{\idealb}$, and $\mu(\ideala, \idealb, p^e)$ and $\crit(\ideala, \idealb)$, defined in the introduction.  However, given that $\ideala$ is a monomial ideal, \Cref{reduce-to-monomial-case: C} in \Cref{monomial-reduction: A} tells us that we may also assume that $\idealb$ is monomial as well.  In fact, \hl{add the result} allows us to further assume that $\idealb$ is a monomial ideal generated by positive powers of each of the ambient variables.
