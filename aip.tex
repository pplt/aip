...
Given $e \geq 1$, notice that the program $\Pi_p(A, \vv{u}, p^e)$ has at least as many constraints as $\Pi_p(\widetilde{A}, \vv{w},p^e)$, so
$\feas \Pi_p(A, \vv{u}, p^e) \subseteq \Pi_p(\widetilde{A}, \vv{w}, p^e)$.
On the other hand, if $\vv{k} \in \feas \Pi_p(\widetilde{A}, \vv{w},p^e)$, then 
...
Since $\vv{k} \geq \vv{0}$, and arithmetic constraint is also satisfied, we conclude that the feasible set of $\Pi_p(\widetilde{A}, \vv{w}, p^e)$ sits inside that of $\Pi_p(\widetilde{A}, \vv{w}, p^e)$, so they must coincide. 
Hence 
\[
 \val\Pi_p(\widetilde{A}, \vv{w}, p^e) = \val \Pi_p(A, \vv{u}, p^e) = \mu(\ideala, \ideald, p^e)
\]
