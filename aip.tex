...
The
% \daniel{I added the adjective \emph{convex} here, since the cone generated by a set could also mean all nonnegative multiplies of elements of that set}
(convex) \emph{cone generated by points $\vv{u}_1,\ldots,\vv{u}_k \in \RR^n$}, denoted $\cone(\vv{u}_1,\ldots,\vv{u}_k)$, is the set consisting of all points of the form $\sum_{i=1}^k \lambda_i \vv{u}_i$, where the $\lambda_i$ are nonnegative real numbers.
...
\todo{Mention the term ``convex combination'', and perhaps also ``conical combination''.}
