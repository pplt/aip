...
\pedro{Is the universal denominator inherited by the descendants? Or do we pick the lcm of universal denominators of all descendants?}\emily{I think we need to fix one for all descendants.}\pedro{I modified it, to say that}
\end{enumerate}
\end{remark}
...
\begin{remark}[Elementary observations]
   ...
   \begin{enumerate}
      ...
      \pedro{$A$ and descendants?}\emily{Yes, I think we need this.}\pedro{I made the change}
   \end{enumerate}
\end{remark}
...
\begin{remark}[The $\idealm$-primary homogeneous case]
   ...
   \pedro[inline]{Maybe we could bring up this case more often throughout the paper; e.g., as an example then introducing minimal face, universal denominator, etc. }
\end{remark}
