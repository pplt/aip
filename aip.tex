...
\delta_{r^s}(\matA, \vv{u}) & \hspace{62pt} \text{if }1 \leq s \leq \mathcal{E}_r(\matA, \vv{u}) \\ 
1 & \hspace{62pt} \text{if } s >  \mathcal{E}_r(\matA, \vv{u}) \\ 
\end{cases}
\end{align*}
...
\end{proposition}
\daniel[inline]{Update the proof.  Maybe address what is going on in the context of the second part of \Cref{fundamental-sequences: L}.}
