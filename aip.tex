...
The proof of the claim shows that a special point $\vv{r}$ for $(\overline{B}, \overline{\vv{v}} )$ satisfies $\tail{\vv{r}}_p = \vv{r}$, and $\vv{0} \in \feas \Theta(B,\vv{v},\vv{r},p)$ (see the proof of \Cref{bounded value: P}). 
Hence $\overline{\vv{v}} = \overline{B}\vv{r} = \overline{B}\tail{\vv{r}}_p - \overline{B} \, \vv{0} \in \ushort(B, \vv{v}, p)$, and $(\overline{B}, \overline{\vv{v}}) \in \S_{pq}(A, \vv{u})$.
...
given any $p$-sprout $(\overline{B}, \vv{w})$ of $(B, \vv{v})$, $\ft{\overline{B}}{\vv{w}} \leq \ft{B}{\vv{v}}$ by our earlier observation.  Hence $(\overline{B}, \overline{\vv{v}}) \in \S^\ast_{pq}(A, \vv{u})$.
