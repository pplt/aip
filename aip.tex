...
\item[$\Box$] Replace any remaining instances of $d$ for dimension with {\tt \text{numvars}}, and fix any inconsistencies. 
   \begin{itemize}
      ...
      \emily[inline]{Like $\mathfrak{m}$, I am OK using this notation; I don't think it is confusing since vectors all have the same text styling.}
...
%$(J:_A I)A _p = (JA_p :_{A_p} IA_p)$ for all $p \gg 0$.
 \end{lemma}
