...
\daniel[inline]{This still needs some work.  The original statement appears below.  In the proof, will need to add a statement before \Cref{uniform uniform value and image: T} that points out that \[ \deg(\matA, \vv{u}) \cdot q - \udeficit(\matA, \vv{u}, q)  \] is always a nonnegative integer}
