...
\pedro[inline]{
   Mention that some terminology and results on convex geometry is gathered in Appendix A.
}
...
As noted in \Cref{face: P}, these definitions depend only on $\O$, but not on the choice of $\defpt$.
The next proposition---a refinement of \Cref{face: P}---shows that the cone generated by $\rb(\O)$ is the recession cone of $\O$, motivating our choice of terminology.
