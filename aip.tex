...
All of the considerations made in \Cref{convenient algorithm: R} about the potential inefficiency and impracticality of the algorithm for the $\idealm$-primary case still apply here.
We are, however, able to compute small examples in a matter of a few seconds.
We show off this ability here, in \Cref{ex: ft.5,ex: new example.2}, and in \Cref{ex: ft.6}
