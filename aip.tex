...
\includegraphics[width=.47\textwidth]{Pictures/opt_for_collapse_may_change.pdf}
\includegraphics[width=.52\textwidth]{Pictures/opt_for_collapse_may_change_2.pdf}

\pedro[inline]{The Newton polyhedra for the first example, and its collapse.}
\vskip 1cm
\includegraphics[width=.5\textwidth]{Pictures/newton_polyhedron.pdf}
\includegraphics[width=.4\textwidth]{Pictures/newton_polyhedron_of_collapse.pdf}
...
Suppose $(A, \vv{u}, \vv{s}, q)$ is a monomial list.  If $(\collapse{A}, \collapse{\vv{u}})$ is the collapse of $(A ,\vv{u})$ along $\O = \mf(A, \vv{u})$, then \Cref{collapse of mf and mc: C} implies that 
