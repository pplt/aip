...
\begin{theorem}[Deficit and shortfall of $\IP$ \emph{vs}.\ $\udeficit$ and $\ushort$]
...
\begin{example}[$\IP(A,\vv{u},p)$ \emph{vs.} $\IP_p(A,\vv{u},p)$ for a small but not very small pair]
