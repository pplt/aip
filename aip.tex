...
\end{equation}
We will show that this limit can be realized as the value of a linear program in $\RR^n$, and also has a very simple description in terms of the Newton polyhedron of $A$.
...
\begin{proposition}
   The value of the linear program $\LP(A,\vv{u})$ is the limit in~\eqref{eq: limit}.
\end{proposition}
