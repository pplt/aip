...
\begin{proof}
   ...
   Denoting the $i$-th column of $A$ by $\vv{a}_i$, we have
   \[
...
\begin{example}\label{ex: ft}
   ...
   Thus, \Cref{FT descriptions: P}\ref{value} again tells us that
