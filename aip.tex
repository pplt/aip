...
\begin{example}
   ...
   \end{figure}
   \Cref{fig: small vs very small} shows the Newton polyhedron of the matrix \daniel{Is it necessary to explicitly indicate the matrix $A$ here?  We could maybe say this is typical of the picture of two variables.}
   \[A=
      \begin{bmatrix}
         1&3&7&10\\
         10&6&3&2
